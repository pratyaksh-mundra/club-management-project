...
top = Label(manager, text="NEW MEMBERS", fg="white", bg="#94958B", font="verdana 24 bold").grid(row=0, column=1)
...
b1 = Button(manager, text="INSERT", font="30", fg="white", bg="#464655", width="20", command=insert).grid(row=5,
                                                                                                          column=1)
b2 = Button(manager, text="DISPLAY", font="30", fg="white", bg="#464655", width="20", command=display_membership).grid(
    row=6, column=1)
...
b3 = Button(manager, text="DELETE", font="30", fg="white", bg="#464655", width="20", command=delete_membership).grid(
    row=9, column=1)
empty = Label(manager, bg="#EDDFEF").grid(row=11, column=0)
# endregion

# region employee part, querying and buttons


top1 = Label(manager, text="EMPLOYEE", fg="white", bg="#94958B", font="verdana 24 bold").grid(row=12, column=1)
...
b1 = Button(manager, text="INSERT", font="30", fg="white", bg="#464655", width="20", command=insert_employee).grid(
    row=17, column=1)
b2 = Button(manager, text="DISPLAY", font="30", fg="white", bg="#464655", width="20", command=display_employee).grid(
    row=18, column=1)
empty = Label(manager, bg="#EDDFEF").grid(row=19, column=0)
...
b3 = Button(manager, text="DELETE", font="30", fg="white", bg="#464655", width="20", command=delete_employee).grid(
    row=21, column=1)
# endregion

# region add or remove activities
top = Label(manager, text="ADD/REMOVE ACTIVITIES", fg="white", bg="#94958B", font="verdana 24 bold").grid(row=0,
                                                                                                          column=6)
...
b1 = Button(manager, text="INSERT", font="30", fg="white", bg="#464655", width="20", command=insert_activities).grid(
    row=3, column=6)
b2 = Button(manager, text="DISPLAY", font="30", fg="white", bg="#464655", width="20", command=display_activities).grid(
    row=4, column=6)
...
b3 = Button(manager, text="DELETE", font="30", fg="white", bg="#464655", width="20", command=delete_activities).grid(
    row=6, column=6)
...
top = Label(manager, text="PAYMENTS", fg="white", bg="#94958B", font="verdana 24 bold").grid(row=8, column=6)
...
b1 = Button(manager, text="INSERT", font="30", fg="white", bg="#464655", width="20", command=insert_mp).grid(row=16,
                                                                                                             column=6)
b2 = Button(manager, text="DISPLAY", font="30", fg="white", bg="#464655", width="20", command=display_mp).grid(row=17,
                                                                                                               column=6)
...
b3 = Button(manager, text="DELETE", font="30", fg="white", bg="#464655", width="20", command=delete_mp).grid(row=19,
                                                                                                             column=6)
...
top = Label(manager, text="attendance", fg="white", bg="#94958B", font="verdana 16 bold").grid(row=0, column=8)
date1 = Label(manager, text="ENTER DATE:").grid(row=1, column=7)
date1_field = Entry(manager)
date1_field.grid(row=1, column=8, ipadx="50")
b3 = Button(manager, text="DISPLAY", font="30", fg="white", bg="#464655", width="10", command=display_attendance).grid(
    row=2, column=8)
# endregion

# region family part
top = Label(manager, text="FAMILY", fg="white", bg="#94958B", font="verdana 24 bold").grid(row=4, column=8)
...
b1 = Button(manager, text="INSERT", font="30", fg="white", bg="#464655", width="20", command=insert_fam).grid(row=9,column=8)
...
b2 = Button(manager, text="DISPLAY", font="30", fg="white", bg="#464655", width="20", command=display_fam).grid(row=11,column=8)
...
b3 = Button(manager, text="DELETE", font="30", fg="white", bg="#464655", width="20", command=delete_fam).grid(row=13,column=8)
empty = Label(manager, bg="#EDDFEF").grid(row=20, column=8)
# endregion
